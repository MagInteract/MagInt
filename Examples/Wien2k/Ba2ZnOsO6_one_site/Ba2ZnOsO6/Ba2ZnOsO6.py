...
U_int = [3.2]  # Interaction strength
J_hund = [0.5]  # Hund's coupling
...
n_mult = [1]
n_ineq = 0
LS = [2]  # Orbital momentum for solver for each shell
...
for iteration_number in range(1, Loops + 1):
    ...
    for i_sh in SK.corr_to_inequiv:
        ...
        if Kanamori is True:
            ...
            S[i_sh].solve(U_int=U_int[i_sh], J_hund=J_hund[i_sh], Test_Convergence=1e-30, verbosity=verbosity,remove_split=False)
