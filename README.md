...
MagInt works with python 3 and is tested with python 3.12. 
...
Please make sure that you have valid TRIQS, TRIQS/DFTTools and TRIQS/dftkit installations matching the required versions for MagInt. 
